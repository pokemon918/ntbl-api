...
let wineData = require('../data/OIVdemo.json');
...
if (!adminEmail) kill('Please provide EMAIL');
if (!adminPass) kill('Please provide PASS');
if (!contestRef) kill('Please provide CONTEST_REF');
